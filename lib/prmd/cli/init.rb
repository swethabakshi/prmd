    ...
    module Init
      ...
      def self.execute(options = {})
        ...
        if File.exists?(path)
          ...
          write_result Prmd.init(name, options), output_file: path
        ...
        if options[:level] >= 3
          ...
          if File.exists?(path)
            ...
            write_result Prmd.generate('organization/event', options.merge(tpl: 'generate_event.json.erb')), output_file: path
        ...
        if options[:level] >= 3
          ...
          if File.exists?(path)
            ...
            write_result Prmd.generate('organization/resource_instance', options.merge(tpl: 'generate_resource_instance.json.erb')), output_file: path
        ...
        if new_project
          ...
          if File.exists?(path)
            ...
            write_result Prmd.generate('organization/virtual_machine', options), output_file: path
        ...
        if new_project && options[:level] >= 3
          ...
          if File.exists?(path)
            ...
            write_result Prmd.generate('organization', options), output_file: path
          ...
          if File.exists?(path)
            ...
            write_result Prmd.generate('user', options), output_file: path
