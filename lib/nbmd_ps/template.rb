...
module NbmdPs
  ...
  class Template
    ...
    # @return [String] location of the nbmd_ps templates directory
    def self.template_dirname
      File.join(File.dirname(__FILE__), 'templates')
    end

    # @param [String] args
    # @return [String] path in nbmd_ps's template directory
    ...
    # Load a JSON file from nbmd_ps's templates directory.
