module NbmdPs #:nodoc:
  module MultiLoader #:nodoc:
    ...
    # @return [Hash<String, NbmdPs::MultiLoader::Loader>]
    @file_extensions = {}
    ...
    def self.autoload_loader(name)
      ...
      require "nbmd_ps/multi_loader/#{loader_name}"
      true
    rescue
      false
    end
    ...
    #
    # @param [String] ext
    # @return [NbmdPs::MultiLoader::Loader]
    # @eg
    #   # by default, NbmdPs does not load the TOML Loader
    ...
    #   # to locate a Loader named "nbmd_ps/multi_loader/toml"
    ...
    # @param [String] data
    # @eg
    #   NbmdPs::MultiLoader.load_data('.json', json_string)
    ...
    # @param [IO] stream
    # @eg
    #   NbmdPs::MultiLoader.load_stream('.json', io)
    ...
    # @eg
    #   NbmdPs::MultiLoader.load_file('my_file.json')
    ...
    module Loader
      ...
      def extensions(*args)
        args.each do |file|
          NbmdPs::MultiLoader.file_extensions[file] = self
        end
      end
